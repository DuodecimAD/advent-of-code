...
public class Console {
	...
	private static final BufferedReader lecteur = new BufferedReader(new InputStreamReader(System.in));

	private static final LinkedBlockingQueue<String> saisies = new LinkedBlockingQueue<>();
